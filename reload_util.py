...
tooltip_bits = filtering + " config gui.guiutil display_options tooltip protocols displayframe bookframe bibleframe genbooktree genbookframe gui.reference_display_frame search.highlighted_frame preview_window header_bar versecompare mainframe"
