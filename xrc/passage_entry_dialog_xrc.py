...
class xrcPassageEntryDialog(wx.Dialog):
#!XRCED:begin-block:xrcPassageEntryDialog.PreCreate
...
#!XRCED:end-block:xrcPassageEntryDialog.PreCreate

    def __init__(self, parent):
        # Two stage creation (see http://wiki.wxpython.org/index.cgi/TwoStageCreation)
        pre = wx.PreDialog()
        self.PreCreate(pre)
        get_resources().LoadOnDialog(pre, parent, "PassageEntryDialog")
        self.PostCreate(pre)
